        ...
        public void showForceUpdateDialog() {
            {
                ...
                /*------- Fonts --------*/
                /*tvTitleDialog.setTypeface(App.getFont_Bold());
                tvTxt.setTypeface(App.getFont_Regular());
                tvNo.setTypeface(App.getFont_Regular());
                tvYes.setTypeface(App.getFont_Regular());*/
